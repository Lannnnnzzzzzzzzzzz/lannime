                ...
                <div className="flex flex-wrap gap-2">
                  {info.Genres.map((genre, index) => (
                    <Link
                      ...
                      key={index}
                      className="text-[14px] font-semibold px-2 py-[1px] border border-gray-400 rounded-2xl hover:text-[#10b981]"
                    >
                      {genre}
                    </Link>
                  ))}
        ...
        <div>
          {seasons?.length > 0 && (
            <div className="flex flex-col gap-y-7 mt-8">
              <h1 className="w-fit text-2xl text-[#10b981] max-[478px]:text-[18px] font-bold">
                More Seasons
              </h1>
